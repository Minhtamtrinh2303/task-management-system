...
class FileAttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create file_attachment" do
    assert_difference("FileAttachment.count") do
      post file_attachments_url, params: { file_attachment: { file_name: @file_attachment.file_name, file_path: @file_attachment.file_path, task_id: @file_attachment.task_id } }
    end
  ...
  test "should update file_attachment" do
    patch file_attachment_url(@file_attachment), params: { file_attachment: { file_name: @file_attachment.file_name, file_path: @file_attachment.file_path, task_id: @file_attachment.task_id } }
